...
export function generateGovernor(config: GovernorConfig): string {
  const {
    name,
    tokenName,
    votingDelay = 7200,
...
// Voting delay: ${votingDelay} blocks (~1 day)
// Voting period: ${votingPeriod} blocks (~1 week)
// Quorum: ${quorumPercent}%
// Proposal threshold: ${proposalThreshold} votes
`;
}
